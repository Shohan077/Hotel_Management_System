   ...
   public AllRooms() {
	...
	btn5.addActionListener(this);
	 try  
			...
			FileInputStream fis=new FileInputStream("F:/Desktop 24-09-2022/java project/hotel/data/addrooms.txt");   
	 ...
	 {  
		 ...
		 else if(e.getSource() == btn2)
		 {
                ...
                if (selectedRow != -1) {
                    ...
                    writeDataToFile("F:/Desktop 24-09-2022/java project/hotel/data/addrooms.txt");
                } else {
             ...
             for (int i = 0; i < model.getRowCount(); i++) {
                ...
                for (int j = 0; j < model.getColumnCount(); j++) {
					if(model.getValueAt(i, j) != null){
						if(j==0){
					row.append("Room No :"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==1){
					row.append("Room Status :"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==2){
					row.append("Bed Type:"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==3){
					row.append("Clean Status :"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==4){
