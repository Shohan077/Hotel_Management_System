...
public class AddRooms implements ActionListener
{
	...
	public AddRooms()
	{
		...
		ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("image\\Addroms1.jpg"));
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		try{
            ...
            File myObj = new File("F:/Desktop 24-09-2022/java project/hotel/data/addrooms.txt");
    ...
    Files.write(Paths.get("F:/Desktop 24-09-2022/java project/hotel/data/addrooms.txt"), all.getBytes(), StandardOpenOption.APPEND);
