...
public class AllEmployee implements ActionListener {
    ...
    private String[] column = { "Name", "Age", "Job Position", "Salary", "Phone","Email" };
   ...
   public AllEmployee() {
	...
	btn5.addActionListener(this);
	 try  
			...
			FileInputStream fis=new FileInputStream("F:/Desktop 24-09-2022/java project/hotel/data/addemployee.txt");   
		   ...
		   if(value == ""){
			...
			model.addRow(new Object[]{valueToshowOntable[0],valueToshowOntable[1], valueToshowOntable[2], valueToshowOntable[3], valueToshowOntable[4],valueToshowOntable[5]});		
    ...
    model.addRow(new Object[]{valueToshowOntable[0],valueToshowOntable[1], valueToshowOntable[2], valueToshowOntable[3], valueToshowOntable[4],valueToshowOntable[5]});		
		...
		ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("image\\allemployee.jpg"));
	 ...
	 {  
		 ...
		 else if(e.getSource() == btn2)
		 {
                ...
                if (selectedRow != -1) {
                    ...
                    writeDataToFile("F:/Desktop 24-09-2022/java project/hotel/data/addemployee.txt");
                } else {
             ...
             for (int i = 0; i < model.getRowCount(); i++) {
                ...
                for (int j = 0; j < model.getColumnCount(); j++) {
					if(model.getValueAt(i, j) != null){
						if(j==0){
					row.append("Name:"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==1){
					row.append("Age :"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==2){
					row.append("Job Position :"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==3){
					row.append("Salary  :"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==4){
					row.append(" Phone :"+ model.getValueAt(i, j));
					row.append("\n");
					
					}
					if(j==5){
					row.append(" Available Status : :"+ model.getValueAt(i, j));
					row.append("\n");
					
					}
					if(j==6){
					row.append(" Email :"+ model.getValueAt(i, j));
					row.append("\n");
