...
public class AllDrivers implements ActionListener {
   ...
   public AllDrivers() {
	...
	btn5.addActionListener(this);
	 try  
			...
			FileInputStream fis=new FileInputStream("F:/Desktop 24-09-2022/java project/hotel/data/addDvivers.txt");   
	 ...
	 {  
		 ...
		 else if(e.getSource() == btn2)
		 {
                ...
                if (selectedRow != -1) {
                    ...
                    writeDataToFile("F:/Desktop 24-09-2022/java project/hotel/data/addDvivers.txt");
                } else {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filename))) {
             for (int i = 0; i < model.getRowCount(); i++) {
                ...
                for (int j = 0; j < model.getColumnCount(); j++) {
					...
					if(j==1){
					row.append("NID :"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==2){
					row.append("Car Type :"+ model.getValueAt(i, j));
						row.append("\n");
					}
					if(j==3){
					row.append("Car Type :"+ model.getValueAt(i, j));
