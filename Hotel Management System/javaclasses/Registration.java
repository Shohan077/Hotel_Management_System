...
frame = new JFrame();
		...
		new TextPrompt("Password (Java17365)", passwordField);
		new TextPrompt("Confirm Password (Java17365)", confirmPasswordField);
		...
		// Hide & Unhide Section
		on = new ImageIcon("image\\unhide.png");
        off = new ImageIcon("image\\hide.png");
    ...
    boolean registerUser(String username, String email, String password) {
        try {
            ...
            FileWriter fileWriter = new FileWriter("F:/Desktop 24-09-2022/java project/hotel/data/singup.txt");
