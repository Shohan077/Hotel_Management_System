...
{	
	...
	private Random ran;
	  ...
	  private JRadioButton male,female,single,married,current,savings;
	  private JButton next,back;
		...
		AdminRegister()
		{
		   ...
		   this.setIconImage(icon.getImage());
			...
			ran = new Random ();
			long  random =Math.abs(ran.nextLong()%10000);
			
			
			 rTitle = new JLabel("APPLICATION FORM NO."+random);
			rTitle.setFont(new Font ("Raleway",Font.BOLD,37));
			rTitle.setBounds(200,20,600,40);
			this.add(rTitle);
			
				 pTitle = new JLabel("Page 1:personal Details(Admin) ");
			...
			/////////////////////////////////Ratio button     for  Status and  gender       ////////////////////////////////////////
			...
			//////////////////////////////button///////////////////////////////////////
				...
				next.addActionListener(new ActionListener() { 
					...
					{		//tName,tfName,tmName,tBirth,tMail,tBlood,tNationality,tNumber
						...
						else
						{
							...
							File file1 = new File("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\admin_data.txt");
							...
							setVisible(false);
						AdminRegister2 siginup2 = new AdminRegister2 ();
