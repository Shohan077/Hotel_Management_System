	   ...
	   AdminLogin(){
	     ...
	     //icon image 
		   ...
		   this.setIconImage(icon.getImage());
		    ...
		    title = new JLabel("XS BANK(Admin)");			
					...
					public void actionPerformed (ActionEvent e)
					{
						...
						if(textUser.isEmpty()||textPass.isEmpty())
						{
							...
							try{
								...
								BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\admin_data.txt"));
								...
								{
								String line = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\admin_data.txt")).get(i);
										
															
															
									   if(line.equals(userNames)){

										  String line2 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\admin_data.txt")).get(i+1);
