	...
	private JLabel name, fName,mName, birth,gender,mail,status,nationality, blood ,number,pTitle,bank,under,accout;
	  ...
	  private JButton back;
		...
		try{	
			...
			name11 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-11);
			father11 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-10);
			mother11 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-9);
			birth11 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-8);
			blood11 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-7);
			email11 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-6);
			nationality11 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-5);
			number11 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-4);
			 gender11= Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-3);
			status11 = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a-2);
			type = Files.readAllLines(Paths.get("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt")).get(a+2);
