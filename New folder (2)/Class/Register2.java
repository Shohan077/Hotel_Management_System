		...
		Register2()
		{
		   ...
		   this.setIconImage(icon.getImage());
			...
			////////////////////////////// title part ///////////////////////////////////////
			 ...
			 rTitle = new JLabel("XS BANK");//+random);
			...
			//////////////////////////////button///////////////////////////////////////
				...
				registration.addActionListener(new ActionListener(){
						...
						else
						{
							...
							File file = new File("C:\\Users\\Md.Tanjil Amin\\OneDrive\\Desktop\\New folder (2)\\data\\user_data.txt");
					...
					//		LocalDataTime myDataObj = LocalDataTime.now();
							
						//	String timeDataData = myDataObj.format(myDataObj);
