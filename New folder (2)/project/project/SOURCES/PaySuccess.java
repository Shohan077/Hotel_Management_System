...
public class PaySuccess extends JFrame {
    ...
    PaySuccess() {
        ...
        label1.setBounds(250, 150, 500, 50);
        label1.setFont(f1);
        c.add(label1);

        label1 = new JLabel();
        label1.setText("Thanks for being with us.");
        label1.setBounds(250, 200, 500, 50);
        label1.setFont(f1);
        c.add(label1);
