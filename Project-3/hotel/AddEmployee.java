...
public class AddEmployee implements ActionListener
{
	...
	public AddEmployee()
	{
		...
		ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("hotelemployee.png"));
	   ...
	   String s6 = jobBox.getSelectedItem().toString();
		 ...
		 else if(e.getSource()==submit)
		 {
		    ...
		    try
		   {
			  ...
			  File myObj = new File("addemployee.txt");
			...
			System.out.println("File already exists.");
			 ...
			 all+= "Email : "+s5+"\n";
			 all+= "\n";
			Files.write(Paths.get("addemployee.txt"), all.getBytes(), StandardOpenOption.APPEND);
