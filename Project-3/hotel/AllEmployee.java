   ...
   public AllEmployee() {
	...
	btn5.addActionListener(this);
	 try  
			...
			FileInputStream fis=new FileInputStream("addemployee.txt");   
    ...
    model.addRow(new Object[]{valueToshowOntable[0],valueToshowOntable[1], valueToshowOntable[2], valueToshowOntable[3], valueToshowOntable[4],valueToshowOntable[5]});		
		...
		ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("allemployee.jpg"));
	 ...
	 {  
		 ...
		 else if(e.getSource() == btn2)
		 {
                ...
                if (selectedRow != -1) {
                    ...
                    writeDataToFile("addemployee.txt");
                } else {
