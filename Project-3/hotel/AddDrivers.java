...
public class AddDrivers implements ActionListener
{
	...
	public AddDrivers()
	{
		...
		ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("hotelcar1.jpg"));
	 ...
	 {  
	     ...
	     if(e.getSource()==addDriver)
		 {
			  ...
			  try
		   {
			  ...
			  File myObj = new File("addDvivers.txt");
			...
			Files.write(Paths.get("addDvivers.txt"), all.getBytes(), StandardOpenOption.APPEND);
