...
{ 
	...
	ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("hotelman1.jpg"));
	label = new JLabel(i1);
	
	label.setBounds(280,5,300,300);
	uname.setBounds(160,50, 100,30);
	upass.setBounds(160,100, 100,30);
	category.setBounds(160,150, 100,30);
    login.setBounds(50,200,95,30); 
	quit.setBounds(160,200,95,30);
	singup.setBounds(105,250,95,30);
